...
- The Portal stores and associates IP addresses with specific users for authentication, session management and security, and geolocation purposes.
  - The Portal uses your IP address for managing individual sessions and suspicious activity monitoring.
  - The Portal uses your IP address to determine your location to provide weather and timezone data.
    - The Portal always stores and uses IP addresses on the login page.
...
- The Portal stores your Discord user ID if provided. Your Discord user ID is used for authentication.
